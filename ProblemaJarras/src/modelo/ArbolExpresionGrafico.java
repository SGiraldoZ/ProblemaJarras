...
public class ArbolExpresionGrafico extends JPanel 
{
    ...
    private HashMap posicionNodoBs = null;
    ...
    {
         posicionNodoBs.clear();
         subtreeSizes.clear();
         NodoB root = this.miArbol.getRaiz();
         if (root != null) 
         {
     ...
     * @param n:Objeto de la clase NodoBB <T> que se utiliza como
     * referencia calcular el tamaño de cada subárbol.
     * @return Dimension con el tamaño de cada subárbol.
     */
    private Dimension calcularTamañoSubarbol(NodoB n) 
    {
          if (n == null) 
     ...
     * va a ser dibujado.
     * @param n: Objeto de tipo NodoBB <T> que se utiliza como
     ...
     */
    private void calcularPosicion(NodoB n, int left, int right, int top) 
    {
      if (n == null) 
          return;
      ...
      int width = fm.stringWidth(n.getLlave()+"");
 
      posicionNodoBs.put(n,new Rectangle(center - width/2 - 3, top, width + 6, fm.getHeight()));
     ...
     * @param n: Objeto de la clase NodoBB <T> que se utiliza como referencia para dibujar el árbol.
     ...
     */
    private void dibujarArbol(Graphics2D g, NodoB n, int puntox, int puntoy, int yoffs) 
    {
     if (n == null) 
         return;
     
     Rectangle r = (Rectangle) posicionNodoBs.get(n);
     g.draw(r);
     g.drawString(n.getLlave()+"", r.x + 3, r.y + yoffs);
